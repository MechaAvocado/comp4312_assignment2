...
def list_files():
    ...
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_1000demo', type=str)
        file_names = []
        #####################
        # Your code is here #
        ####################
...
def create_bk():
    ...
    try:
        ...
        bucket_name = request.args.get('bucket_name', default='comp4312_10000demo', type=str)
        from storage_create_bucket import create_bucket
